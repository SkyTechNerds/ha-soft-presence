    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_DISABLE_DOOR_ENTRY, default=DEFAULT_DISABLE_DOOR_ENTRY): selector.BooleanSelector(),
            }),
        )
    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Required(CONF_DISABLE_DOOR_ENTRY, default=data.get(CONF_DISABLE_DOOR_ENTRY, DEFAULT_DISABLE_DOOR_ENTRY)): selector.BooleanSelector(),
            }),
        )
